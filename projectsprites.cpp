...
int main() {
    ...
    sf::RenderWindow window(sf::VideoMode(1080, 720), "bja955@bu.edu");
    sf::Vector2f borderSize;
    float borderEndx = (window.getSize().x / 9.f);
    float borderEndy = (window.getSize().y / 9.f);
    borderSize.x = window.getSize().x - borderEndx;
    borderSize.y = window.getSize().y - borderEndy;
    sf::Texture spritesheet;
    sf::RectangleShape gameBorder(sf::Vector2f(borderSize.x,borderSize.y));
    gameBorder.setPosition(10.f,10.f);
